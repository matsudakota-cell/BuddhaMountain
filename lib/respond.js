...
const CATEGORIES = [
  {
    name: 'bug',
    keywords: ['bug', 'error', 'crash', 'crashed', 'exception', 'broken', 'broke', 'fails', 'failing', 'stack trace', 'undefined', 'null', 'fix', 'debug'],
    templates: [
  ...
  {
    name: 'burnout',
    keywords: ['tired', 'exhausted', 'burnout', 'burned out', 'overwhelmed', 'stressed', 'anxious', 'anxiety', 'can\'t focus', 'cant focus', 'sloppy', 'worn out', 'drained', 'running low', 'running on fumes', 'hours straight', 'losing focus', 'no sleep'],
    templates: [
  ...
  {
    name: 'meta',
    keywords: ['who are you', 'what are you', 'what is this', 'buddha', 'mountain', 'are you real', 'are you an llm', 'are you a bot', 'chatbot', 'knowledge base'],
    templates: [
